...
function getSurveyProfiles_() {
  ...
  return [{
    ...
    questions:[
      ...
      {no:11,title:"자료이용편의 평가 점수",type:"SCORE",scoreMap:scoreMap,tokens:["자료이용편의","평가","점수"]},
      {no:12,title:"사서의 참고서비스 평가 점수",type:"SCORE",scoreMap:scoreMap,tokens:["사서","참고서비스","평가","점수"]},
      {no:13,title:"온라인 정보제공 평가 점수",type:"SCORE",scoreMap:scoreMap,tokens:["온라인","정보제공","평가","점수"]},
