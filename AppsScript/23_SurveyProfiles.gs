...
function getSurveyProfiles_() {
  ...
  return [{
    ...
    questions:[
      ...
      {no:2,title:"중원도서관을 이용하는 목적은 무엇입니까?",type:"MULTIPLE",multipleChoices:[],tokens:["중원도서관","이용","목적"]},
      {no:3,title:"도서관에서 소장중인 자료 중 자주 이용하는 자료는 무엇입니까?",type:"MULTIPLE",multipleChoices:[],tokens:["소장중인자료","자주이용","자료"]},
      {no:4,title:"대출할 자료를 선택할 때 주로 고려하는 기준은 무엇입니까?",type:"MULTIPLE",multipleChoices:["신문, 인터넷 등 미디어 추천도서"],tokens:["대출할자료","선택","고려","기준"]},
      {no:5,title:"중원도서관에서 제공하는 자료 이용 서비스 중 알고 있는 항목을 선택해 주십시오.",type:"MULTIPLE",groupId:"자료 이용 서비스 인지도",multipleChoices:["내 생애 첫 도서관, 두루두루, 책나래 등 무료 도서 대출서비스 (임산부, 영·유아, 장애인 대상)"],tokens:["중원도서관","자료이용서비스","알고있는항목"]},
      {no:6,title:"중원도서관 홈페이지에서 제공하는 정보 및 서비스 중 이용해 본 항목을 선택해 주십시오.",type:"MULTIPLE",groupId:"홈페이지 서비스 이용 경험",multipleChoices:["(독서‧도서정보) 화제의 책, 신착도서, 서평한마디(책 읽어주는 사서), 전자책 등","(특화 코너) 여행정보 , 청소년 정보 등","(커뮤니티) 페이스북, X(舊 트위터), 블로그, 인스타그램, 유튜브, 카카오톡 채널 등"],tokens:["중원도서관홈페이지","정보및서비스","이용해본항목"]},
      {no:7,title:"중원도서관에서 제공하는 독서정보 중 도움을 받은 항목을 선택해 주십시오.",type:"MULTIPLE",groupId:"독서정보 도움 경험",multipleChoices:["(커뮤니티) 페이스북, X(舊 트위터), 인스타그램, 블로그, 유튜브, 카카오톡 채널"],tokens:["중원도서관","독서정보","도움을받은항목"]},
